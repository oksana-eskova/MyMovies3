    ...
    public static ArrayList<Movie> getMoviesFromJSON(JSONObject jsonObject){
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                String backdropPath=BASE_POSTER_URL+BIG_POSTER_SIZE+objectMovie.getString(KEY_BACKDROP_PATH);
    ...
    public static ArrayList<Trailer> getTrailersFromJSON(JSONObject jsonObject){
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                String key=BASE_YOUTUBE_URL+objectTrailer.getString(KEY_KEY_VIDEO);
